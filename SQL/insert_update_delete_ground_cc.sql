CREATE OR REPLACE PROCEDURE laboratory.insert_ground_cc(
...
CREATE OR REPLACE PROCEDURE laboratory.update_ground_cc(
    lab_id_param VARCHAR,
    header_id_param NUMERIC,
    field_id_param VARCHAR,
    pH_param NUMERIC,
...
CREATE OR REPLACE PROCEDURE laboratory.delete_ground_cc(
    lab_id_param VARCHAR
)
BEGIN ATOMIC  
